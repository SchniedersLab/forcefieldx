...
// Unit:    Class edu.rit.mp.buf.DoubleArrayBuf_1
//
 ...
 * While an instance of class DoubleArrayBuf may be constructed directly,
 * normally you will use a factory method in class {@linkplain
 * edu.rit.mp.DoubleBuf DoubleBuf}. See that class for further information.
 *
...
// Exported constructors.
     ...
     */
    public DoubleArrayBuf_1(double[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new DoubleArrayReductionBuf_1(myArray, myRange, (DoubleOp) op);
    }
...
// Hidden operations.
    ...
    protected int receiveItems(int i,
            ...
            ByteBuffer buffer) {
        DoubleBuffer doublebuffer = buffer.asDoubleBuffer();
        int n = Math.min(num, Math.min(myLength - i, doublebuffer.remaining()));
