...
// Unit:    Class edu.rit.mp.buf.SharedShortArrayBuf_1
//
 ...
 * array of short items sent or received using the Message Protocol (MP). The
 * array element stride must be 1. While an instance of class
 * SharedShortArrayBuf_1 may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.ShortBuf ShortBuf}. See that
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedShortArrayReductionBuf_1(myArray, myRange, (ShortOp) op);
    }
