...
// Unit:    Class edu.rit.mp.buf.SharedShortArrayBuf
//
...
/**
 * Class SharedShortArrayBuf provides a buffer for a multiple thread safe array
 * of short items sent or received using the Message Protocol (MP). The array
 * element stride may be 1 or greater than 1. While an instance of class
 * SharedShortArrayBuf may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.ShortBuf
...
// Exported constructors.
     ...
     */
    public SharedShortArrayBuf(SharedShortArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedShortArrayReductionBuf(myArray, myRange, (ShortOp) op);
    }
