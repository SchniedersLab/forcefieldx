...
// Unit:    Class edu.rit.clu.timing.TimeBcastDouble
//
 ...
 * <P>
 * Usage: java -Dpj.np=<I>K</I> edu.rit.clu.timing.TimeBcastDouble <I>reps</I>
 * <I>n1</I> [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			System.out.println
				("java -Dpj.np=" + size +
				 " edu.rit.clu.timing.TimeBcastDouble " + reps);
