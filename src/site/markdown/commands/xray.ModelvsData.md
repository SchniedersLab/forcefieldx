...
Compare the PDB model to the diffraction data.

---
```
Usage: ffxc ModelvsData [-AhpStUw] [--rmo] [--sf] [--aRadBuffer=0.75] [--FSigFCutoff=-1.0] [--nBins=10] [--nResidueBFactor=0] [--sigmaATol=0.05] [--sol=POLYNOMIAL] [--wA=1.0] [--xrayScaleTol=1.0e-4] [-B=1.0] [-G=0.6] [-m=coordinates] [-R=-1] [-X=<data> <data> <data>]... files...
Compare the PDB model to the diffraction data.
...
-p, --maps                      Output sigmaA weighted 2Fo-Fc and Fo-Fc electron density maps.
...
-t, --timings                   Perform FFT timings.
-U, --addAnisoU                 Add Anisotropic B-Factors to refinement.
-w, --mtz                       write out MTZ containing structure factor coefficients.
