### X-ray Target Molecular Dynamics

Run molecular dynamics on an X-ray target.

---
```
Usage: ffxc xray.Dynamics [-AhoSU] [--rmo] [--sf] [--aRadBuffer=0.75] [--FSigFCutoff=-1.0] [--nBins=10] [--nResidueBFactor=0] [--sigmaATol=0.05] [--sol=POLYNOMIAL] [--wA=1.0] [--xrayScaleTol=1.0e-4] [-b=Bussi] [-B=1.0] [-d=1.0] [-G=0.6] [-i=Verlet] [-k=1.0] [-m=coordinates] [-n=1000000] [-r=0.25] [-R=-1] [-t=298.15] [-w=10.0] [-X=<data> <data> <data>]... files...
