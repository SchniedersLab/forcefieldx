### Many-Body Rotamer Optimization

Run Many-Body rotamer optimization on a system.

---
```
Usage: ffxc ManyBody [-EhOTz] [--dee] [--out] [--bB=0.0] [--bC=1] [--bL=20.0] [--ch=-1] [--eR=none] [--fi=-1] [--fR=-1,-1] [--increment=3] [--Ln=Richardson] [--lR=none] [--mC=-1] [--nB=3,3,3] [--pr=1] [--radius=2.0] [--tC=3.0] [--thC=3.0] [--window=7] [-a=0] [-L=2] [-s=-1] [-x=-1] files...
