...
// Unit:    Class edu.rit.mp.buf.CharacterMatrixReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public CharacterMatrixReductionBuf_1(char[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            CharacterOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("CharacterMatrixReductionBuf_1(): op is null");
        }
        myOp = op;
    }
