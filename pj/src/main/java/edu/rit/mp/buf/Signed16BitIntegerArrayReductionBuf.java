...
// Unit:    Class edu.rit.mp.buf.Signed16BitIntegerArrayReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Signed16BitIntegerArrayReductionBuf(int[] theArray,
            Range theRange,
            IntegerOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("Signed16BitIntegerArrayReductionBuf(): op is null");
        }
        myOp = op;
    }
