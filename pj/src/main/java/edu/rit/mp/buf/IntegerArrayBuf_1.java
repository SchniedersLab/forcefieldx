...
// Unit:    Class edu.rit.mp.buf.IntegerArrayBuf_1
//
 ...
 * 1. While an instance of class IntegerArrayBuf may be constructed directly,
 * normally you will use a factory method in class {@linkplain
 * edu.rit.mp.IntegerBuf IntegerBuf}. See that class for further information.
 *
...
// Exported constructors.
     ...
     */
    public IntegerArrayBuf_1(int[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new IntegerArrayReductionBuf_1(myArray, myRange, (IntegerOp) op);
    }
