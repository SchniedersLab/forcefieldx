...
// Unit:    Class edu.rit.mp.buf.ShortMatrixBuf
//
 ...
 * may be 1 or greater than 1. While an instance of class ShortMatrixBuf may be
...
// Exported constructors.
     ...
     */
    public ShortMatrixBuf(short[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new ShortMatrixReductionBuf(myMatrix, myRowRange, myColRange, (ShortOp) op);
    }
