...
// Unit:    Class edu.rit.mp.buf.SharedUnsigned16BitIntegerBuf
//
...
// Exported constructors.
     ...
     */
    public SharedUnsigned16BitIntegerBuf(SharedInteger item) {
        super(1);
        myItem = item;
    }
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedUnsigned16BitIntegerReductionBuf(myItem, (IntegerOp) op);
    }
