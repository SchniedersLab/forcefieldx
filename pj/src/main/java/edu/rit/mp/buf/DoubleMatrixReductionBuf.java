...
// Unit:    Class edu.rit.mp.buf.DoubleMatrixReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public DoubleMatrixReductionBuf(double[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            DoubleOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("DoubleMatrixReductionBuf(): op is null");
        }
        myOp = op;
    }
