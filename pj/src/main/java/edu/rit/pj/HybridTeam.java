...
// Exported constructors.
    ...
    /**
     * Construct a new hybrid team with the given number of threads per process
    ...
    /**
     * Construct a new hybrid team with the given number of threads per process
     * and using the given communicator for message passing.
     *
     * @param K Number of threads per process.
     * @param comm Communicator to use for message passing.
     *
    ...
    public HybridTeam(int K,
        ...
        lowestIndex[rank] = K;
        IntegerBuf[] bufs
                = IntegerBuf.sliceBuffers(lowestIndex,
