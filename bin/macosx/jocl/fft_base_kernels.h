...
static string recipKernel = string("__kernel void \\\n"
                                   "multiply(__global float* real, __global float* imag, __global const float* recip, int numElements) \\\n"
                                   "{ \\\n"
                                   "int iGID = get_global_id(0); \\\n"
                                   "if (iGID >= numElements) { return; } \\\n"
        			   "real[iGID] *= recip[iGID]; \\\n"
                                   "imag[iGID] *= recip[iGID]; \\\n"
                                   "} \\\n"
                                   );
