...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Djava.library.path="%BASEDIR%/windows/jogl-32" -Dapp.name="ffx" -Dj3d.rend="jogl" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" ffx.Main %CMD_LINE_ARGS%
