...
@REM set CLASSPATH="%BASEDIR%"\etc;"%BASEDIR%"\bin\forcefieldx-"%VERSION%".jar
...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="Force Field X" -Dj3d.rend="noop" -Djava.awt.headless=true -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" ffx.Main %CMD_LINE_ARGS%
