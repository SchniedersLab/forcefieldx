...
// type of refinement
RefinementMode refinementmode = RefinementMode.OCCUPANCIES;
...
diffractiondata.writeModel(FilenameUtils.removeExtension(modelfilename) + "_occ.pdb");
diffractiondata.writeData(FilenameUtils.removeExtension(modelfilename) + "_occ.mtz");
