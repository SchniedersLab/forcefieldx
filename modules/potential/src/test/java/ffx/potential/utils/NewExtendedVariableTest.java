...
public class NewExtendedVariableTest {
...
//            {EsvTest.Deriv_Meta,    Interactions.All,   CellType.Aperiodic},
	...
	public NewExtendedVariableTest(EsvTest test, Interactions interactions, CellType cell) {
		this.test = test;
    ...
    public static void setUpClass() {
        ...
        setProp("permanent-lambda-exponent",	0.0);
