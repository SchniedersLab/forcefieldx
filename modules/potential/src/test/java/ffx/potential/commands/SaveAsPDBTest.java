...
public class SaveAsPDBTest extends PotentialTest {

  @Test
  public void testSaveAsPDB() {
    // Set-up the input arguments for the SaveAsPDB script.
    String filepath = getResourcePath("peptide-amber99sb.xyz");
    String[] args = {filepath};
    binding.setVariable("args", args);
    binding.setVariable("baseDir", registerTemporaryDirectory().toFile());

    // Construct and evaluate the SaveAsPDB script.
    SaveAsPDB saveAsPDB = new SaveAsPDB(binding).run();
    potentialScript = saveAsPDB;
  }
