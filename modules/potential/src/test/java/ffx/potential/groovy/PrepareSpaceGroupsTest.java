...
public class PrepareSpaceGroupsTest extends PotentialTest {
  ...
  public void testPrepareSpaceGroupHelp() {
    ...
    PrepareSpaceGroups prepareSpaceGroups = new PrepareSpaceGroups(binding).run();
    potentialScript = prepareSpaceGroups;

    // Check the PrepareSpaceGroup results.
    assertEquals(0, prepareSpaceGroups.numberCreated);
  }
  ...
  public void testPrepareSpaceGroups() {
    ...
    // Check the PrepareSpaceGroup results.
    assertEquals(230, prepareSpaceGroups.numberCreated);
  ...
  public void testPrepareSpaceGroupsAChiral() {
    ...
    // Check the PrepareSpaceGroup results.
    assertEquals(165, prepareSpaceGroups.numberCreated);
  }
  ...
  public void testPrepareSpaceGroupsChiral() {
    ...
    // Check the PrepareSpaceGroup results.
    assertEquals(65, prepareSpaceGroups.numberCreated);
  }
}
