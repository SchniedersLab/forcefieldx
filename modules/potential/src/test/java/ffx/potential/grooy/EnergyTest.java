...
public class EnergyTest {
    ...
    @Before
    public void before() {
        binding = new groovy.lang.Binding();
        energy = new Energy();
        energy.setBinding(binding);
    }

    @Test
    public void testEnergyHelp() {
        ...
        Assert.assertEquals(0.0, energy.energy, 1.0e-6);
    }
    ...
    public void testEnergy() {
        ...
        Assert.assertEquals(-41.03245062, energy.energy, 1.0e-6);
    }
}
