...
public class StretchTorsion extends BondedTerm implements LambdaInterface {
     ...
     */
    public StretchTorsion(Angle a, Bond b) {
        super();
        bonds = new Bond[3];
        bonds[0] = b;
        bonds[1] = a.getBond(0);
     ...
     * @param b3 Bond
     */
    public StretchTorsion(Bond b1, Bond b2, Bond b3) {
        super();
        bonds = new Bond[3];
        bonds[0] = b1;
        bonds[1] = b2;
     ...
     * @param n Torsion id
     */
    public StretchTorsion(String n) {
        super(n);
    }
    ...
    /**
     * Attempt to create a new StretchTorsion based on the supplied bonds. There is no
     ...
     */
    public static StretchTorsion stretchTorsionFactory(Bond bond1, Bond middleBond, Bond bond3, ForceField forceField) {
        ...
        String key = StretchTorsionType.sortKey(c);
        ...
        if (stretchTorsionType == null) {
            ...
            c[2] = atom2.getAtomType().atomClass;
            c[3] = 0;
            key = StretchTorsionType.sortKey(c);
            stretchTorsionType = forceField.getStretchTorsionType(key);
        }
        if (stretchTorsionType == null) {
            c[0] = 0;
            c[1] = atom1.getAtomType().atomClass;
        ...
        if (stretchTorsionType == null) {
            ...
            c[3] = bond3.getOtherAtom(middleBond).getAtomType().atomClass;
            key = StretchTorsionType.sortKey(c);
            logger.severe(format("No StretchTorsionType for key: %s\n%s\n%s\n%s\n",
        ...
        stretchTorsion.units = forceField.getDouble(ForceField.ForceFieldDouble.TORSIONUNIT, 0.5);
    ...
    public double energy(boolean gradient,
        ...
        logger.warning(" StretchTorsion Energy is incomplete.");
