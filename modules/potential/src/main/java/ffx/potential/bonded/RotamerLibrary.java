...
public class RotamerLibrary {
    ...
    private static SolvationLibrary solvationLibrary = SolvationLibrary.GK;
    ...
    /**
     * Set the solvation library to use.
     * 
     * @param name the SolvationLibrary to use.
     */
    public static void setSolvationLibrary(SolvationLibrary name) {
        solvationLibrary = name;
    }
     ...
     */
    public static double getSolvationEnergy(Residue residue, boolean checkZeroes) throws IllegalArgumentException {
        String resName = "";
        double energy = 0;
        switch (residue.getResidueType()) {
            case AA:
                ...
                energy = RotamerLibrary.getSolvationEnergy(AminoAcid3.valueOf(resName));
                break;
            case NA:
                if (residue instanceof MultiResidue) {
                    resName = ((MultiResidue) residue).getActive().getName();
                ...
                energy = RotamerLibrary.getSolvationEnergy(NucleicAcid3.valueOf(resName));
                break;
            default:
                energy = 0;
        }
     ...
     * @return Solvation energy
     */
    public static double getSolvationEnergy(AminoAcid3 name) {
     ...
     */
    public static double getSolvationEnergy(NucleicAcid3 name) {
        return 0;
    }
     ...
     * @return Relative solvation energy
     */
    public static double getGKSolvationEnergy(AminoAcid3 name) {
        return getExplicitSolvationEnergy(name);
    }
     ...
     * @return Relative solvation energy
     */
    public static double getExplicitSolvationEnergy(AminoAcid3 name) {
        switch (name) {
            case ALA:
                return 0.58;
            case CYS:
     ...
     * @return Solvation energy
     */
    public static double getMacCallumTIP4PSolvationEnergy(AminoAcid3 name) {
        switch (name) {
            case ALA:
                return 9.8;
            case CYS:
     ...
     * @return Solvation energy
     */
    public static double getMacCallumSPCSolvationEnergy(AminoAcid3 name) {
        switch (name) {
            case ALA:
                return 9.3;
            case CYS:
     ...
     * @return Solvation energy
     */
    public static double getCabaniSolvationEnergy(AminoAcid3 name) {
        switch (name) {
            case ALA:
                return 8.4;
            case CYS:
     ...
     * @return Solvation energy
     */
    public static double getWolfendenSolvationEnergy(AminoAcid3 name) {
        switch (name) {
            case ALA:
                return 8.1;
            case CYS:
