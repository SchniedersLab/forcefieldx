...
public class Angle extends BondedTerm {
    ...
    private static void inPlaneGrad(
            int threadID,
    ...
    public double energy(
        ...
        energy = 0.0;
        value = 0.0;
        var prefactor = units * rigidScale * angleType.forceConstant;
                                        ...
                                        prefactor * esvLambda
                                                ...
                                                * toDegrees(
                                                2.0
                                                        ...
                                                        + 6.0 * sextic * dv4);
                                inPlaneGrad(
                                        threadID, grad, ia, ib, ic, id, vad, vbd, vcd, vp, rp2, vjp, jp2, vkp, kp2,
                                        delta, deddt);
                            }
                            value = dv;
                        }
    ...
    /**
     * If the specified atom is not the central atom of <b>this</b> angle, the atom of the opposite
     * leg is returned. These atoms are said to be 1-3 to each other.
     *
     * @param a Atom
     * @return Atom
     */
    ...
    /**
     * If the central atom of the angle is trigonal, the 4th member of the trigonal center (that is
     * not a part of the angle) will be returned.
     *
