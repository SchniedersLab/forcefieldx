...
public class ScfPredictor {
    ...
    private int nAtoms;
    /**
     * Maps LambdaMode to array indices:
     *  OFF/CONDENSED=0, CONDENSED_NOLIGAND=1, VAPOR=2
     */
    private int mode;
    ...
    /**
     * Predicts induced dipoles by locally minimizing and testing
     * eps against squared change in parameters.
     */
    ...
    public ScfPredictor(PredictorMode mode, int order, ForceField ff) {
        ...
        int defaultOrder = 6;
        CompositeConfiguration ffConfig = ff.getProperties();
        predictorMode = mode;
