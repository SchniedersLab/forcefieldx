...
/**
 * Parallel calculation of the Generalized Kirkwood reaction field energy using a quasi-internal
 * frame.
 *
...
public class GKEnergyRegionQI extends ParallelRegion {
  ...
  private class GKEnergyLoop extends IntegerForLoop {
    ...
    private void interaction(int i, int k) {
      ...
      // TODO: Here is the place where we need to rotate multipole moments into the QI-frame.
      xr = dx_local[0];
      yr = dx_local[1];
      zr = dx_local[2];
      rbk = born[k];

      // TODO: 1) We need to determine a rotation matrix.
      // TODO: 2) We can then set xr = 0, yr = 0, and zr = r (the separation distance).
      xr2 = xr * xr;
      yr2 = yr * yr;
      zr2 = zr * zr;
      // TODO: 3) We can then set xr2 = 0, yr2 = 0, and zr2 = r^2.
      // TODO: 4) We need to apply the rotation matrix to multipole & induced dipole for atom i.
      ...
      syk = dyk + pyk;
      szk = dzk + pzk;
      // TODO: 5) We need to apply the rotation matrix to multipole & induced dipole for atom k.
      ...
      // TODO: Many QI energy tensor components will be zero.
      energyTensors();

      // Compute the GK interaction energy.
      // TODO: Many QI multipole-multipole interactions will be zero.
      ...
      if (gradient) {
        ...
        // TODO: Many QI gradient tensor components will be zero.
        gradientTensors();

        // Compute the permanent GK energy gradient.
        // TODO: Many QI permanent energy gradient components will be zero.
        permanentEnergyGradient(i, k);
        if (polarization != Polarization.NONE) {
          // Compute the induced GK energy gradient.
          // TODO: Many QI polarization energy gradient components will be zero.
    ...
    private double energy(int i, int k) {
      ...
      if (polarization != Polarization.NONE) {
        // TODO: Many multipole-induced dipole interactions will be zero.
        double esymi =
    ...
    private void permanentEnergyGradient(int i, int k) {
      ...
      // TODO: Rotate QI dedx, dedy, dedz back into the lab frame from the QI frame.
      dedxi -= dedx;
      dedyi -= dedy;
      dedzi -= dedz;
    ...
    private double dEdZ() {
      // TODO: Many QI dEdZ permanent energy gradient components are zero.
    ...
    private double dEdY() {
      // TODO: Many QI dEdY permanent energy gradient components are zero.
    ...
    private double dEdX() {
      // TODO: Many QI dEdX permanent energy gradient components are zero.
    ...
    private void permanentEnergyTorque(int i, int k) {
      // TODO: Many QI permanent energy torque components are zero.
      ...
      // TODO: Rotate QI torques back into the lab frame.
      trqxi += tix;
      trqyi += tiy;
      trqzi += tiz;
    ...
    private void polarizationEnergyGradient(int i, int k) {
      // TODO: Many QI polarization energy gradient components are zero.
      ...
      if (i == k && iSymm == 0) {
        ...
        // TODO: Rotate QI polarization gradient back into the lab frame.
        dedxi -= dpdx;
        dedyi -= dpdy;
        dedzi -= dpdz;
        dborni += dbi;
    ...
    private void polarizationEnergyTorque(int i, int k) {
      // TODO: Many QI polarization energy torque components are zero.
      ...
      // TODO: Rotate QI polarization torques back into the lab frame.
      trqxi += tix;
      trqyi += tiy;
      trqzi += tiz;
      final double rx = tkx;
