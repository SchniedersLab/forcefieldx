...
public class OpenMMPlatform {
   ...
   */
  public static OpenMMStringArray loadPluginsFromDirectory(String directory) {
    return new OpenMMStringArray(OpenMM_Platform_loadPluginsFromDirectory(directory));
  }
   ...
   */
  public static OpenMMStringArray getPluginLoadFailures() {
    return new OpenMMStringArray(OpenMM_Platform_getPluginLoadFailures());
  }
