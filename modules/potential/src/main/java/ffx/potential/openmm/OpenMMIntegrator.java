...
class OpenMMIntegrator {
  ...
  public PointerByReference createIntegrator(String integratorString, double timeStep, double temperature, OpenMMSystem openMMSystem) {
    switch (integratorString) {
      ...
      case "LANGEVIN" -> {
        CompositeConfiguration properties = openMMSystem.forceField.getProperties();
        int seed = 0;
      ...
      case "LANGEVIN-MTS" -> createCustomMTSLangevinIntegrator(timeStep, temperature, frictionCoefficient, openMMSystem);
    }
