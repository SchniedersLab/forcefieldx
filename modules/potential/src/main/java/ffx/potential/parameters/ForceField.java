...
//            logger.info(" Adding iSolvRadType to map: " + iSolvRadType.getKey() + "/" + iSolvRadType);
    ...
    public enum ForceFieldDouble {
        ...
        A_AXIS, B_AXIS, C_AXIS, ALPHA, BETA, GAMMA, POLAR_DAMP, POLAR_SOR, POLAR_EPS, POLAR_EPS_PRECISE,
        EWALD_CUTOFF, EWALD_ALPHA, EWALD_PRECISION, PME_MESH_DENSITY, VDW_CUTOFF, MPOLE_11_SCALE,
        MPOLE_12_SCALE, MPOLE_13_SCALE, MPOLE_14_SCALE, MPOLE_15_SCALE, POLAR_12_SCALE, POLAR_13_SCALE,
        DIRECT_11_SCALE, RIGID_SCALE, VDW_LAMBDA_EXPONENT, VDW_LAMBDA_ALPHA,
        PERMANENT_LAMBDA_START, PERMANENT_LAMBDA_END, PERMANENT_LAMBDA_EXPONENT, PERMANENT_LAMBDA_ALPHA,
        POLARIZATION_LAMBDA_START, POLARIZATION_LAMBDA_END, POLARIZATION_LAMBDA_EXPONENT,
        POLARIZATION_LAMEDH_START, POLARIZATION_LAMEDH_END,
        ...
        VDW_12_SCALE, VDW_13_SCALE, VDW_14_SCALE, VDW_15_SCALE, GK_EPSILON, GK_BONDIOVERRIDE,
        GK_OVERLAPSCALE
    }
