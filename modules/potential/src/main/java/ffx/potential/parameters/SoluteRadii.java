...
public class SoluteRadii {
  ...
  /**
   * Lithium Ion Li+ Wang Thesis: -116.91 kca/mol
   *
   * <p>AMOEBA 2009 Class 6
   *
   * <p>Generalized Kirkwood -119.29504846 Cavitation 3.34060579 Dispersion -0.93488991 Solvation
   * -116.88933258
   */
  private static final double GK_AMOEBA_LITHIUM = 2.748;
  /**
   * Sodium Ion Na+ Wang Thesis: -91.62 kcal/mol Grossfield et al: -91.8 kcal/mol
   *
   * <p>AMOEBA 2009 Class 7
   *
   * <p>Generalized Kirkwood -94.17489031 Cavitation 4.64284122 Dispersion -2.05069286 Solvation
   * -91.58274195
   */
  private static final double GK_AMOEBA_SODIUM = 3.481;
  /**
   * Potassium Ion K+ Wang Thesis: -74.32 kca/mol Grossfield et al: -74.5 kca/mol
   *
   * <p>AMOEBA 2009 Class 8
   *
   * <p>Generalized Kirkwood -77.49947829 Cavitation 6.17608374 Dispersion -3.06353750 Solvation
   * -74.38693205
   */
  ...
  // No "phase potential" correction is applied for moving ions across the vacuum - liquid
  // interface.
  /**
   * Rubidium Ion Rb+ Wang Thesis: -69.05 kcal/mol
   *
   * <p>AMOEBA 2009 Class 9
   *
   * <p>Generalized Kirkwood -72.20766370 Cavitation 6.70040723 Dispersion -3.53557505 Solvation
   * -69.04283152
   */
  private static final double GK_AMOEBA_RUBIDIUM = 4.540;
  /**
   * Cesium Ion Cs+ Wang Thesis: -63.66 kcal/mol
   *
   * <p>AMOEBA 2009 Class 10
   *
   * <p>Generalized Kirkwood -66.79356014 Cavitation 7.30534462 Dispersion -4.16432764 Solvation
   * -63.65254316
   */
  private static final double GK_AMOEBA_CESIUM = 4.908;
  /**
   * Magnesium Ion Mg+2 Ren et al. 2006: -431.1 kcal/mol Expt: −435.4 kcal/mol
   *
   * <p>AMOEBA 2009 Class 11
   *
   * <p>Generalized Kirkwood -434.20237507 Cavitation 4.61414342 Dispersion -2.08752589 Solvation
   * -431.67575754
   */
  private static final double GK_AMOEBA_MAGNESIUM = 3.020;
  /**
   * Calcium Ion Ca+2 Ren et al. 2006: -354.9 kcal/mol Expt: −357.2 kcal/mol
   *
   * <p>AMOEBA 2009 Class 12
   *
   * <p>Generalized Kirkwood -357.98284813 Cavitation 6.06086494 Dispersion -2.98489939 Solvation
   * -354.90688258
   */
  private static final double GK_AMOEBA_CALCIUM = 3.663;
  /**
   * Zinc Ion Zn+2 Ren et al. 2011: −458.9 Expt: −467.7 kcal/mol
   *
   * <p>AMOEBA 2009 Class 13
   *
   * <p>Generalized Kirkwood -461.55972288 Cavitation 4.13533119 Dispersion -1.73074989 Solvation
   * -459.15514158
   */
  private static final double GK_AMOEBA_ZINC = 2.841;
  /**
   * Fluoride Ion F- Wang Thesis: -116.71 kcal/mol
   *
   * <p>AMOEBA 2009 Class 14
   *
   * <p>Generalized Kirkwood -119.90592289 Cavitation 5.61431867 Dispersion -2.41793122 Solvation
   * -116.70953544
   */
   ...
   * Chloride Ion Cl-
   *
   * <p>Target Data: Grossfield et al: -86.5 kca/mol (from previous AMOEBA Chloride parameters).
   * Wang Thesis: -86.12 kca/mol (from 2018). Nonpolar solvation: 2.87 kcal/mol
   *
   * <p>AMOEBA 2009 Class 15
   *
   * <p>Generalized Kirkwood -89.54460344 Cavitation 7.25565967 Dispersion -3.86494289 (Nonpolar
   * total: 3.39) Solvation -86.15388666
   */
  private static final double GK_AMOEBA_CHLORIDE = 3.661;
  /**
   * Bromide Ion Br- Wang Thesis: -79.66 kca/mol
   *
   * <p>AMOEBA 2009 Class 16
   *
   * <p>Generalized Kirkwood -82.80444384 Cavitation 7.78219576 Dispersion -4.64697404 Solvation
   * -79.66922212
   */
  private static final double GK_AMOEBA_BROMIDE = 3.959;
  /**
   * Iodide Ion I- Wang Thesis: -71.25 kca/mol
   *
   * <p>AMOEBA 2009 Class 17
   *
   * <p>Generalized Kirkwood -74.05077777 Cavitation 8.59369359 Dispersion -5.79174929 Solvation
   * -71.24883347
   */
   ...
   * Methane CH4 Carbon
   *
   * <p>AMOEBA 2009 Class 25
   */
  private static final double GK_AMOEBA_METHANE_CH4 = 4.914;
  /**
   * Methane H4C Hydrogen
   *
   * <p>AMOEBA 2009 Class 26
   */
  private static final double GK_AMOEBA_METHANE_H4C = 3.770;
  /**
   * Ethane CH3 Carbon Alkane -CH2- Alkane >CH- Alkane >C<
   *
   * <p>AMOEBA 2009 Classes 27, 29, 31 and 33
   */
  private static final double GK_AMOEBA_ALKANE_C = 4.584;
  /**
   * Ethane H3C Hydrogen Alkane -H2C- Alkane -HC<
   *
   * <p>AMOEBA 2009 Class 28, 30 and 32
   */
  private static final double GK_AMOEBA_ALKANE_H = 3.576;
  /**
   * Water Oxygen
   *
   * <p>AMOEBA 2009 Class 34
   *
   * <p>TODO: Combine with Alcohol Oxygen?
   */
  private static final double GK_AMOEBA_WATER_O = 2.9964;
  /**
   * Water Hydrogen
   *
   * <p>AMOEBA 2009 Class 35
   */
  private static final double GK_AMOEBA_WATER_H = 2.3895;
  /**
   * Methanol O, Ethanol O, isoPropanol O, Methyl Ether O Phenol OH, p-Cresol OH
   *
   * <p>AMOEBA 2009 Class 36
   */
  private static final double GK_AMOEBA_ALCOHOL_O = 2.9964;
  /**
   * Methanol HO, Ethanol HO, isoPropanol HO, Phenol HO, p-Cresol HO
   *
   * <p>AMOEBA 2009 Class 37
   */
  private static final double GK_AMOEBA_ALCOHOL_HO = 2.3364;
  /**
   * Methanol CH3
   *
   * <p>AMOEBA 2009 Class 38
   *
   * <p>TODO: Combine with Ethanol C?
   */
  private static final double GK_AMOEBA_METHANOL_C = 3.384;
  /**
   * Methanol H3C, Ethanol H2C, isoPropanol >CH-
   *
   * <p>AMOEBA 2009 Class 39
   *
   * <p>TODO: Combine with Ethanol HC?
   */
  private static final double GK_AMOEBA_METHANOL_HC = 2.583;
  /**
   * Ethanol Carbon, Propanol Me-CH2, Propanol CH3, isoPropanol CH3 Methyl Ether CH3 Methyl Amine
   * CH3, Ethyl Amine CH2, Ethyl Amine CH3, Propyl Amine CH3 Propyl Amine Me-CH2, Dimethyl Amine
   * CH3, Trimethyl Amine CH3 Pyrrolidine C-CH2-C, Pyrrolidine CH2-N NMePyrrolidine CH2-N,
   * NMePyrrolidine CH2<, NMePyrrolidine CH3-N Acetamide CH3, Propamide Me-CH2, Propamide CH3
   * NMeFormamide CH3, NEtFormamide CH2-N
   *
   * <p>AMOEBA 2009 Class 40
   */
  private static final double GK_AMOEBA_POLARGROUP_C = 3.438;
  /**
   * Ethanol Hydrogen, Propanol H3C, isoPropanol H3C Ethyl Amine H3C, Propyl Amine H3C Propamide
   * H3C, NEtFormamide H3C Ethyl Sulfonate H3C, Propyl Sulfonate H3C Ethylbenzene H2C, Ethylbenzene
   * H3C, Toluene H3C 4-Ethylimidazole H2C, 4-Ethylimidazole H3C 3-Ethylindole H2C, 3-Ethylindole
   * H3C
   *
   * <p>AMOEBA 2009 Class 41
   */
  private static final double GK_AMOEBA_POLARGROUP_HC = 2.664;
  /**
   * Propanol Me-CH2, Propyl Amine Me-CH2 NMePyrrolidine H3C-N Propamide Me-CH2 Propyl Sulfonate
   * Me-CH2
   *
   * <p>AMOEBA 2009 Class 42
   *
   * <p>TODO: Combine with Ethanol HC?
   */
   ...
   * 3-Formylindole HC2, 3-Formylindole HC4 to 3-Formylindole HC7 Pyridinium H2 to Pyridinium H4
   *
   * <p>AMOEBA 2009 Class 88
   */
  private static final double GK_AMOEBA_BENZENE_H = 3.9634;
  /**
   * Ethylbenzene C2, Ethylbenzene C3, Ethylbenzene C4, Ethylbenzene C1-CH2 Phenol C1-OH, Phenol C2
   * to Phenol C4, Toluene C1-CH3, Toluene C2 to Toluene C4 p-Cresol C1-CH3, p-Cresol C2, p-Cresol
   * C3, p-Cresol C4-OH Benzamidine C1-CN2, Benzamidine C2 to Benzamidine C4
   *
   * <p>AMOEBA 2009 Class 89
   */
  private static final double GK_AMOEBA_AROMATIC_C = 3.800;
  /**
   * Ethylbenzene H2 to Ethylbenzene H4 Phenol H2 to Phenol H4 Toluene H2 to Toluene H4 p-Cresol H2,
   * p-Cresol H3 Benzamidine H2 to Benzamidine H4
   *
   * <p>AMOEBA 2009 Class 90
   */
  private static final double GK_AMOEBA_AROMATIC_H = 2.980;
  /**
   * Imidazole NH, Imidazole N=C- 4-Ethylimidazole ND, 4-Ethylimidazole NE Indole N 3-Ethylindole N
   * 3-Formylindole N
   *
   * <p>AMOEBA 2009 Class 91
   */
  private static final double GK_AMOEBA_IMIDAZOLE_NH = 3.339;
  /**
   * Imidazole N-C-N, Imidazole C-N=C, Imidazole C-NH- 4-Ethylimidazole CE, 4-Ethylimidazole CD,
   * 4-Ethylimidazole CG
   *
   * <p>AMOEBA 2009 Class 92
   */
  private static final double GK_AMOEBA_IMIDAZOLE_C = 3.591;
  /**
   * Imidazole HC 4-Ethylimidazole HCE, 4-Ethylimidazole HCD
   *
   * <p>AMOEBA 2009 Class 93
   */
  private static final double GK_AMOEBA_IMIDAZOLE_HC = 3.000;
  /** TODO: Fit this so GK matches GXG trimer charging. */
  private static final double GK_AMOEBA_PROTEIN_CARBOXYLIC_ACID_CO =
      3.100; // GK_AMOEBA_CARBONYL_CO;

  private static final double GK_AMOEBA_PROTEIN_CARBOXYLIC_ACID_O =
      2.850; // GK_AMOEBA_CARBOXCYLIC_ACID_O;
  ...
  static {
    ...
    AMOEBA_NUC_2017_GK_RADII.put(
        1, GK_AMOEBA_AROMATIC_C / 2.0); // 1   C   Adenine C4/C5, Guanine C4/C5
    ...
    AMOEBA_NUC_2017_GK_RADII.put(
        5, GK_AMOEBA_METHYLAMINE_N / 2.0); // 5   N   Adenine N6, Cytosine N4, Guanine N2
    AMOEBA_NUC_2017_GK_RADII.put(
        6,
        GK_AMOEBA_AROMATIC_C / 2.0); // 6   C   Adenine C2, Cytosine C6, Thymine C5/C6, Uracil C5/C6
    AMOEBA_NUC_2017_GK_RADII.put(7, GK_AMOEBA_IMIDAZOLE_NH / 2.0); // 7   N   Adenine N7, Guanine N7
    AMOEBA_NUC_2017_GK_RADII.put(
        8, GK_AMOEBA_IMIDAZOLE_NH / 2.0); // 8   N   Adenine N1/N3, Cytosine N3, Guanine N3
    AMOEBA_NUC_2017_GK_RADII.put(
        9,
        GK_AMOEBA_AROMATIC_H
            / 2.0); // 9   H   Adenine H8, Cytosine H6, Guanine H8, Thymine H6, Uracil H6
    AMOEBA_NUC_2017_GK_RADII.put(10, GK_AMOEBA_AROMATIC_H / 2.0); // 10   H   Adenine H2, Uracil H5
    AMOEBA_NUC_2017_GK_RADII.put(
        11, GK_AMOEBA_METHYLAMINE_HN / 2.0); // 11   H   Adenine H61, Cytosine H41, Guanine H21
    AMOEBA_NUC_2017_GK_RADII.put(
        12,
        GK_AMOEBA_IMIDAZOLE_NH
            / 2.0); // 12   N   Cytosine N1 RNA/DNA, Guanine N1, Thymine N3, Uracil N3
    AMOEBA_NUC_2017_GK_RADII.put(13, GK_AMOEBA_BENZENE_C / 2.0); // 13   C   Cytosine C5
    AMOEBA_NUC_2017_GK_RADII.put(
        14,
        GK_AMOEBA_AMIDE_CO / 2.0); // 14   C   Cytosine C2, Guanine C6, Thymine C2/C4, Uracil C2/C4
    AMOEBA_NUC_2017_GK_RADII.put(15, GK_AMOEBA_BENZENE_H / 2.0); // 15   H   Cytosine H5
    AMOEBA_NUC_2017_GK_RADII.put(
        16,
        GK_AMOEBA_CARBONYL_O
            / 2.0); // 16   O   Cytosine O2, Guanine O6, Thymine O2/O4, Uracil O2/O4
    AMOEBA_NUC_2017_GK_RADII.put(
        17, GK_AMOEBA_IMIDAZOLE_C / 2.0); // 17   C   Guanine C2 (this one is tricky...)
    AMOEBA_NUC_2017_GK_RADII.put(18, GK_AMOEBA_IMIDAZOLE_NH / 2.0); // 18   N   Guanine N9 RNA/DNA
    AMOEBA_NUC_2017_GK_RADII.put(
        19, GK_AMOEBA_AMIDE_HN / 2.0); // 19   H   Guanine H1, Thymine H3, Uracil H3
    AMOEBA_NUC_2017_GK_RADII.put(
        20, GK_AMOEBA_POLARGROUP_C / 2.0); // 20   C   Thymine C7 (C5-attached methyl group C)
    AMOEBA_NUC_2017_GK_RADII.put(
        21, GK_AMOEBA_IMIDAZOLE_NH / 2.0); // 21   N   Thymine N1, Uracil N1
    AMOEBA_NUC_2017_GK_RADII.put(22, GK_AMOEBA_POLARGROUP_HC / 2.0); // 22   H   Thymine H7
    // AMOEBA_NUC_2017_GK_RADII.put(23, GK_AMOEBA_CARBONYL_O / 2.0);     // 23   O   Ribose O4
    // (Unsure on this one)
    ...
    AMOEBA_BIO_2018_GK_RADII.put(
        22, GK_AMOEBA_AROMATIC_C / 2.0); // Tryptophan CG, CD1, CD2, CE2, CE3, CZ2, CZ3, CH2
    AMOEBA_BIO_2018_GK_RADII.put(
        23, GK_AMOEBA_AROMATIC_H / 2.0); // Tryptophan HD1, HE3, HZ2, HZ3, HH2
    AMOEBA_BIO_2018_GK_RADII.put(
        24, GK_AMOEBA_PROTEIN_HISTIDINE_NH / 2.0); // Tryptophan NE1, Histidine (+) ND1, NE2
    ...
    AMOEBA_BIO_2018_GK_RADII.put(
        30, GK_AMOEBA_PROTEIN_CARBOXYLIC_ACID_CO / 2.0); // Aspartate CG. Glutamate CD
    AMOEBA_BIO_2018_GK_RADII.put(
        31, GK_AMOEBA_PROTEIN_CARBOXYLIC_ACID_O / 2.0); // Aspartate OD, Glutamate OE
    AMOEBA_BIO_2018_GK_RADII.put(
        32, GK_AMOEBA_CARBONYL_CO / 2.0); // Aspartic Acid CG, Glutamic Acid CD
    AMOEBA_BIO_2018_GK_RADII.put(
        33, GK_AMOEBA_CARBONYL_O / 2.0); // Aspartic Acid OD1, Glutamic Acid OE1
    AMOEBA_BIO_2018_GK_RADII.put(
        34, GK_AMOEBA_CARBOXCYLIC_ACID_O / 2.0); // Aspartic Acid OD2, Glutamic Acid OE2
    AMOEBA_BIO_2018_GK_RADII.put(
        35, GK_AMOEBA_CARBOXCYLIC_ACID_HO / 2.0); // Aspartic Acid HD2, Glutamic Acid HE2
