...
public class TitrationUtils {
  ...
  public enum Titration {
    ...
    ASHtoASP(3.67, -70.85, 0.0, -72.113, 145.959, AminoAcid3.ASH, AminoAcid3.ASP), GLHtoGLU(4.25,
        -82.73, 0.0, -101.22, 179.8441, AminoAcid3.GLH, AminoAcid3.GLU), LYStoLYD(10.40, 41.45, 0.0,
