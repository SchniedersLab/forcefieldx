...
public class TitrationUtils {
  ...
  public enum Titration {
    ...
    ASHtoASP(3.94, -70.35, -35.35,-52.1, -33.87, 12.730, -107.430, 166.369, 0.0, AminoAcid3.ASH, AminoAcid3.ASP),
    ...
    LYStoLYD(10.40, 41.35, 20.0, 41.31, 18.75,6.752, -78.804, 26.894, 0.0, AminoAcid3.LYS, AminoAcid3.LYD),
