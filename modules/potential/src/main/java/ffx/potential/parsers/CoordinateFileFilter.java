...
public final class CoordinateFileFilter extends FileFilter {
   ...
   * {@inheritDoc}
   *
   * <p>This method returns <code>true</code> if the file is a valid coordinate file (xyz, pdb).
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Provides a description of the CoordinateFileFilter.
   */
  @Override
  public String getDescription() {
    return "Protein Databank (*.PDB), TINKER Cartesian Coordinates (*.XYZ),"
