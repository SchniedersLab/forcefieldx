...
public class AlchemicalOptions {
  ...
  public static void setUnchargedAtoms(MolecularAssembly assembly, String unchargedAtoms) {
    actOnAtoms(assembly, unchargedAtoms, (Atom a, Boolean b) -> a.setElectrostatics(!b), "Uncharged");
  }
   ...
   */
  public MolecularAssembly openFile(PotentialsFunctions potentialFunctions,
                                    TopologyOptions topologyOptions, int threadsPer,
                                    String toOpen, int topNum) {
   ...
   * @return The processed MolecularAssembly.
   */
  public MolecularAssembly processFile(@Nullable TopologyOptions topologyOptions,
                                       MolecularAssembly molecularAssembly, int topNum) {
