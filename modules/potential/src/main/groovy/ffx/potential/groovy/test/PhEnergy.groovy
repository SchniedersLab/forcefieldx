...
class PhEnergy extends PotentialScript {
   ...
   * --ec or --energyCutOff Collect structures below a specified energy range from the minimum energy.
   */
  @Option(names = ['--esv', '--esvTerm'], paramLabel = "false", defaultValue = "false",
          description = "Attach ESV and evaluate energies. (Structure must already be saved with ASD/GLD residues)")
