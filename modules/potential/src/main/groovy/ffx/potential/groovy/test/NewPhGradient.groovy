...
class NewPhGradient extends PotentialScript {
  ...
  private void printPermutations(NewExtendedSystem esvSystem, int numESVs, ForceFieldEnergy energy,
      double[] x) {
  ...
  private void printPermutationsR(NewExtendedSystem esvSystem, int esvID, ForceFieldEnergy energy,
      double[] x) {
    for (int i = 0; i <= 1; i++) {
