...
//System.setProperty("esv-debug", "true");
...
logger.info(String.format(" E(1),E(0),diff:  %14.6f - %14.6f = %14.6f", e1, e0, e1-e0));
...
*******************************************************************************/
for (int i = 0; i < numESVs; i++) {
    esvSystem.setAllLambdas(lambda - step);
