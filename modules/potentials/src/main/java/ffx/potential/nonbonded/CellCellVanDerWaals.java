 ...
 * @since 1.0
 */
public class CellCellVanDerWaals extends ParallelRegion implements MaskingInterface,
        LambdaInterface {
     ...
     */
    private final CellCellNeighborList neighborList;
     ...
     * @since 1.0
     */
    public CellCellVanDerWaals(ForceField forceField, Atom[] atoms,
        ...
        neighborList = new CellCellNeighborList(null, this.crystal, atoms, off, buff, parallelTeam);
