...
public class GeneralizedKirkwood {
    ...
    public GeneralizedKirkwood(ForceField forceField, Atom[] atoms,
        ...
        cutoff = forceField.getDouble(ForceField.ForceFieldDouble.VDW_CUTOFF, 9.0);
        cut2 = cutoff * cutoff;
    ...
    public double solvationEnergy(boolean gradient, boolean print) {
        ...
        try {
            ...
            String message = "Fatal exception computing generalized Kirkwood energy.";
            logger.log(Level.SEVERE, message, e);
        }
        ...
        return gkEnergyRegion.getGKEnergy();
    }
