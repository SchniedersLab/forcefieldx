...
public class ForceField {
    ...
    public enum ForceFieldDouble {
        ...
        PERMANENT_LAMBDA_EXPONENT, PERMANENT_LAMBDA_ALPHA, POLARIZATION_LAMBDA_EXPONENT
    }

    public enum ForceFieldInteger {

        PME_ORDER, PME_REAL_THREADS, PME_GRIDX, PME_GRIDY, PME_GRIDZ, LAMBDA_BIAS_CUTOFF
    }
