 ...
 */
class OldThermodynamics extends Script {
    ...
    class Options {
         ...
         */
        @Option(shortName = 'i', longName = 'integrator', convert = { s -> return Integrator.parseIntegrator(s); }, defaultValue = 'Verlet', description = 'Integrator: [Beeman / Respa / Stochastic / Verlet]')
