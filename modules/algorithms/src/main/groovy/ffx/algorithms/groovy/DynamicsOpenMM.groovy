...
class DynamicsOpenMM extends AlgorithmsScript {
     ...
     */
    @Option(names = ['--cf', '--friction'], paramLabel = '0.01',
            description = 'Coefficient of friction to be used with the Langevin integrators.')
     ...
     */
    @Option(names = ['-q', '--collision'], paramLabel = '91.0',
            description = 'Collision frequency for the Anderson thermostat.')
    ...
    DynamicsOpenMM run() {
        ...
        if (moldyn instanceof MolecularDynamicsOpenMM) {
            ...
            if (barostatOpt.pressure > 0) {
                ...
                molDynOpenMM.setBarostatFrequency(barostatOpt.meanInterval)
            }
