 ...
 */
class TTOSRWHistogramReader extends BufferedReader {

    private static final Logger logger = Logger.getLogger(TTOSRWHistogramReader.class.getName());
     ...
     */
    TTOSRWHistogramReader(TransitionTemperedOSRW transitionTemperedOSRW, Reader reader) {
        super(reader);
