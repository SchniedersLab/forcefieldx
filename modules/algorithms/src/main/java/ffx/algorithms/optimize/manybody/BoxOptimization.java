...
public class BoxOptimization{
     ...
     */
    private static final Logger logger = Logger.getLogger(BoxOptimization.class.getName());
    /**
     ...
     */
    public BoxOptimization(MolecularAssembly molecularAssembly, Potential potential, AlgorithmListener algorithmListener,
                          boolean rank0,  boolean writeEnergyRestart, boolean printFiles, BufferedWriter energyWriter) {
...
//                    try {
//                        startingEnergy = currentEnergyWrapper(residueSubsetList);
...
//                    try {
//                        finalEnergy = currentEnergyWrapper(residueSubsetList);
//                    } catch (ArithmeticException ex) {
//                        logger.severe(format(" Exception %s in calculating starting energy of a box; FFX shutting down", ex));
//                    }
