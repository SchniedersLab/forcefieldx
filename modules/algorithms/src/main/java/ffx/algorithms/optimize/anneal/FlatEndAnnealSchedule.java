...
public class FlatEndAnnealSchedule implements AnnealingSchedule {
    ...
    /**
     * Creates a flat-ended annealing schedule based on a provided schedule for the middle, which is flat
     * for some number of steps at the ends.
     *
     ...
     * @param lengthBefore Relative length of the first ("flat") tempering window at the high temperature. 0 disables this end.
     * @param lengthAfter  Relative length of the last ("flat") tempering window at the low temperature. 0 disables this end.
     */
