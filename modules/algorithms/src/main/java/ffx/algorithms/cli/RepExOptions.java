...
public class RepExOptions {
  ...
  private static class RepExOptionGroup {
     ...
     */
    @Option(names = {"-x",
        "--repEx"}, paramLabel = "false", description = "Execute temperature replica exchange")
    boolean repEx = false;
     ...
     */
    @Option(names = {"--rs",
        "--replicaSteps"}, paramLabel = "100", defaultValue = "100", description = "Number of steps for replica exchange.")
     ...
     */
    @Option(names = {"-e",
        "--exponent"}, paramLabel = "0.05", defaultValue = "0.05", description = "Exponent to set the exponential temperature ladder.")
     ...
     */
    @Option(names = {"--oMC",
        "--oneMonteCarlo"}, paramLabel = "false", description = "Execute 1 Monte Carlo move for each temperature in each cycle")
