...
/**
 * The Hierarchy Class creates and manages a JTree view of the data structure. It is used for
 * synchronization, handles the selection mechanism, and sets the active system and nodes.
 *
...
public final class Hierarchy extends JTree implements TreeSelectionListener, TreeModelListener {
  ...
  /**
   * Getter for the field <code>activeNode</code>.
   *
  ...
  public void valueChanged(TreeSelectionEvent e) {
    synchronized (this) {
      ...
      if (RendererCache.highlightSelections) {
        mainPanel
            .getGraphics3D()
            .updateScene(picks, false, false, null, true, RendererCache.ColorModel.SELECT);
  ...
  private void attach(FFXSystem newModel) {
    ...
    if (graphics != null) {
      ...
      if (newModel.getBondList().isEmpty()) {
        mainPanel
            .getGraphics3D()
            .updateScene(newModel, false, true, RendererCache.ViewModel.SPACEFILL, false, null);
      }
    }
  }
  ...
  /**
   * Getter for the field <code>activeNodes</code>.
   *
  ...
  void setHighlighting(boolean h) {
    synchronized (this) {
      if (RendererCache.highlightSelections != h) {
        ...
        mainPanel
            .getGraphics3D()
            .updateScene(activeNodes, false, false, null, true, RendererCache.ColorModel.SELECT);
      }
    }
  }
  ...
  public void treeStructureChanged(TreeModelEvent e) {
    logger.info(" Structure Changed: " + e);
  }
}
