...
/**
 * The LogPanel is a *very* simple editor that displays log files created by TINKER jobs. Any text
 * file can be edited.
 *
...
public class LogPanel extends JPanel implements ActionListener {
  ...
  private void initToolBar() {
    ...
    JButton jbrefresh =
        new JButton(
            new ImageIcon(
                getClass().getClassLoader().getResource("ffx/ui/icons/page_refresh.png")));
    ...
    JButton jbopen =
        new JButton(
            new ImageIcon(getClass().getClassLoader().getResource("ffx/ui/icons/page_open.png")));
    ...
    JButton jbsave =
        new JButton(
            new ImageIcon(getClass().getClassLoader().getResource("ffx/ui/icons/disk.png")));
    ...
    JButton jbsaveas =
        new JButton(
            new ImageIcon(getClass().getClassLoader().getResource("ffx/ui/icons/page_save.png")));
    ...
    JButton jbclose =
        new JButton(
            new ImageIcon(getClass().getClassLoader().getResource("ffx/ui/icons/cancel.png")));
