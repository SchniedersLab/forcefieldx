...
public final class KeywordComponent
  ...
  /**
   * This is used to test if ANY keyword has been modified, so it is static across all keyword
   * objects
   */
  ...
  KeywordComponent(
      String keyword,
      String keywordGroup,
      SwingRepresentation swingRepresentation,
  ...
  static void fillPanel(
      JPanel jPanel, GridBagLayout gridBagLayout, GridBagConstraints gridBagConstraints) {
   ...
   * {@inheritDoc}
   *
   * <p>Overidden equals method return true if object equals this, or if it of the same class and
   * has the same Tinker Keyword.
   */
  @Override
  ...
  /**
   * Getter for the field <code>keyword</code>.
   *
   ...
   * {@inheritDoc}
   *
   * <p>Overridden toString methods facilitates Keyword output to a file.
   */
  @Override
  public String toString() {
    synchronized (this) {
      ...
      if (!keyword.equalsIgnoreCase("TORSION")) {
        s = new StringBuilder(keyword + spaces.substring(0, 18 - keyword.length()));
      } else {
  ...
  /**
   * Getter for the field <code>keywordDescription</code>.
   *
   * @return a {@link java.lang.String} object.
   */
  ...
  /**
   * Getter for the field <code>keywordGroup</code>.
   *
   * @return a {@link java.lang.String} object.
   */
  ...
  /**
   * Returns a JPanel with a GridLayout LayoutManager that contains a Swing representation of the
   * Keyword and Modifiers in a single row.
   *
  ...
  /**
   * Load a single line Keyword entry into this KeywordComponent. Keywords that can be repeated
   * multipule times are ComboBoxes are stored in ComboBoxes.
   *
  ...
  private void textFieldInit() {
    ...
    if (keyword.equalsIgnoreCase("PARAMETERS") || keyword.equalsIgnoreCase("FORCEFIELD")) {
