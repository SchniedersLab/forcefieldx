...
public class MultipoleTensorTest {
    ...
    public void energyAndForceTest() {
        ...
        double energy = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        double aX = Fk[0];
        double aY = Fk[1];
        double aZ = Fk[2];
        r[0] += delta;
        double posX = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[0] -= delta2;
        double negX = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[0] += delta;
        r[1] += delta;
        double posY = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[1] -= delta2;
        double negY = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[1] += delta;
        r[2] += delta;
        double posZ = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[2] -= delta2;
        double negZ = multipoleTensor.interact5(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[2] += delta;
        double expect = aX;
    ...
    public void energyAndForceQITest() {
        ...
        double energy = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        ...
        r[0] += delta;
        double posX = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[0] -= delta2;
        double negX = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[0] += delta;
        r[1] += delta;
        double posY = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[1] -= delta2;
        double negY = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[1] += delta;
        r[2] += delta;
        double posZ = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[2] -= delta2;
        double negZ = multipoleTensor.interact5QI(r, Qi, Qk, Fi, Fk, Ti, Tk);
        r[2] += delta;
