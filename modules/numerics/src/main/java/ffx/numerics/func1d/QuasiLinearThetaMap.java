 ...
 * in a mostly-linear fashion (i.e. rectangular sampling of theta produces
 * roughly rectangular sampling of lambda).
 *
...
public class QuasiLinearThetaMap implements UnivariateDiffFunction {
    ...
    /**
     * Constructs a QuasiLinearThetaMap which is roughly V-shaped from [-pi,+pi],
     * is periodic, and uses trigonometric functions to spline between the linear
     * ranges (theta0-pi, -theta0), (+theta0, pi-theta0) and the trigonometric
     * interpolating regions [-pi, theta0-pi], [-theta0,+theta0] and [pi-theta0, pi].
     *
