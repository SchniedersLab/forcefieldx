...
public class BellCurveSwitch implements UnivariateSwitchingFunction {
  ...
  public boolean constantOutsideBounds() {
    return switchingFunction.constantOutsideBounds()
        && secondSwitchingFunction.constantOutsideBounds();
  }
  ...
  public int getHighestOrderZeroDerivative() {
    return Math.min(
        switchingFunction.getHighestOrderZeroDerivative(),
        secondSwitchingFunction.getHighestOrderZeroDerivative());
  }
  ...
  public String toString() {
    return format(
        " Spliced 5'th order Hermite splines with midpoint " + "%11.5g, width %11.5g",
        midpoint, 2.0 * halfWidth);
  }
