...
public class AmoebaPlusOverlapTensorGlobal extends CoulombTensorGlobal {
   ...
   * @param alphaI The Thole damping parameter for site I.
   * @param alphaK The Thole damping parameter for site K.
   */
   ...
   * Generate source terms for the Challacombe et al. recursion.
   *
   * @param aI   The Thole damping parameter for site I.
   * @param aK   The Thole damping parameter for site K.
   * @param A    The combined damping parameter for site I.
   * @param B    The combined damping parameter for site K.
