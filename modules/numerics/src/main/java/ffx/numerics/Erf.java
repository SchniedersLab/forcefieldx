 ...
 *      <a href="http://en.wikipedia.org/wiki/Error_function" target="_blank">
 *      Error function at Wikipedia</a><br>
...
public class Erf {
	 ...
	 * 
	 * @param arg
	 *            the value to evaluate erf or erfc at.
	 * @param mode
	 *            if mode is true, evaluate erfc, otherwise evaluate erf.
