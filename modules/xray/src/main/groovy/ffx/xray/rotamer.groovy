...
cli.dt(longOpt:'data', args:2, valueSeparator:',', argName:'data.cif,1.0', 'specify input data filename (or simply provide the datafilename argument after the PDB file) and weight to apply to the data (wA)');
cli.I(longOpt:'maxiter', args:1, argName:'1000', 'maximum number of allowed refinement iterations');
cli.X(longOpt:'suffix', args:1, argName:'_refine', 'output suffix');
