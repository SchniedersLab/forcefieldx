...
diffractiondata.writeModel(FilenameUtils.removeExtension(modelfilename) + "_xyz.pdb");
diffractiondata.writeData(FilenameUtils.removeExtension(modelfilename) + "_xyz.mtz");
