...
// Exported constructors.
    ...
    public DynamicIntegerSchedule(int theChunkSize) {
        super();
        if (theChunkSize < 1) {
            throw new IllegalArgumentException("DynamicIntegerSchedule(): Chunk size = " + theChunkSize
                    + " illegal");
        }
        N2 = theChunkSize;
    }
    ...
    private static int getChunkSize(String[] args) {
        ...
        try {
            ...
            throw new IllegalArgumentException("DynamicIntegerSchedule(): Chunk size = " + args[0]
                    + " illegal");
        }
        return theChunkSize;
    }
