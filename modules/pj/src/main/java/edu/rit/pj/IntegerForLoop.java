...
// Package: edu.rit.pj
// Unit:    Class edu.rit.pj.IntegerForLoop
//
...
// Exported operations.
    ...
    public final void ordered(ParallelSection theSection)
        ...
        if (theSection == null) {
            throw new IllegalStateException("IntegerForLoop.ordered(): Parallel section is null");
        }
        if (myTeam == null) {
            throw new IllegalStateException("IntegerForLoop.ordered(): No parallel team executing");
        }
