...
// Unit:    Class edu.rit.mp.buf.Signed8BitIntegerMatrixBuf_1
//
 ...
 * use a factory method in class {@linkplain edu.rit.mp.Signed8BitIntegerBuf
...
// Exported constructors.
     ...
     * be 1.
     */
    public Signed8BitIntegerMatrixBuf_1(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new Signed8BitIntegerMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (IntegerOp) op);
    }
