...
// Unit:    Class edu.rit.mp.buf.SharedDoubleArrayBuf
//
...
/**
 * Class SharedDoubleArrayBuf provides a buffer for a multiple thread safe array
 * of double items sent or received using the Message Protocol (MP). The array
 * element stride may be 1 or greater than 1. While an instance of class
 * SharedDoubleArrayBuf may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.DoubleBuf
...
// Exported constructors.
     ...
     */
    public SharedDoubleArrayBuf(SharedDoubleArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedDoubleArrayReductionBuf(myArray, myRange, (DoubleOp) op);
    }
