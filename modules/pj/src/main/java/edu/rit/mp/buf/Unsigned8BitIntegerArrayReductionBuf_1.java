...
// Unit:    Class edu.rit.mp.buf.Unsigned8BitIntegerArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Unsigned8BitIntegerArrayReductionBuf_1(int[] theArray,
            Range theRange,
            IntegerOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("Unsigned8BitIntegerArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
