...
// Unit:    Class edu.rit.mp.buf.SharedIntegerArrayBuf_1
//
 ...
 * SharedIntegerArrayBuf_1 may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.IntegerBuf IntegerBuf}. See
...
// Exported constructors.
     ...
     */
    public SharedIntegerArrayBuf_1(SharedIntegerArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedIntegerArrayReductionBuf_1(myArray, myRange, (IntegerOp) op);
    }
