...
// Unit:    Class edu.rit.mp.buf.EmptySigned8BitIntegerBuf
//
 ...
 * signed 8-bit <code>int</code> and the message length is 0. When a message is
 * received into an EmptySigned8BitIntegerBuf, the message item type must be
 * signed 8-bit <code>int</code>, but all items in the message are discarded.
 *
