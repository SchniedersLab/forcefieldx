...
// Unit:    Class edu.rit.mp.buf.BooleanItemReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public BooleanItemReductionBuf(BooleanItemBuf buf,
            BooleanOp op) {
        super(1);
        if (op == null) {
            throw new NullPointerException("BooleanItemReductionBuf(): op is null");
        }
        myBuf = buf;
        myOp = op;
    }
