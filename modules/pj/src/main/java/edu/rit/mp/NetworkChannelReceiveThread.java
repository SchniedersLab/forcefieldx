...
// Package: edu.rit.mp
// Unit:    Class edu.rit.mp.NetworkChannelReceiveThread
//
...
// Hidden constructors.
     ...
     */
    NetworkChannelReceiveThread(NetworkChannel theNetworkChannel,
        ...
        for (;;) {
            try {
                ...
                if (magic != Constants.MAGIC_NUMBER) {
                    myChannelGroup.myLogger.log("edu.rit.mp.NetworkChannelReceiveThread: Invalid magic number received");
                ...
                // queue.
                iorequest
                        = myIORequestList.waitForMatch(myNetworkChannel, messagetag, messagetype);
