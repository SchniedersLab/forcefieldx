...
// Unit:    Class edu.rit.mp.buf.ByteMatrixReductionBuf_1
//
...
// Exported constructors.
     ...
     */
    public ByteMatrixReductionBuf_1(byte[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            ByteOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("ByteMatrixReductionBuf_1(): op is null");
        }
        myOp = op;
    }
