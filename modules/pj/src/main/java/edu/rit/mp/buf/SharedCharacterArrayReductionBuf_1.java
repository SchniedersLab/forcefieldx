...
// Unit:    Class edu.rit.mp.buf.SharedCharacterArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public SharedCharacterArrayReductionBuf_1(SharedCharacterArray theArray,
            Range theRange,
            CharacterOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("SharedCharacterArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
