...
// Unit:    Class edu.rit.mp.buf.CharacterMatrixBuf_1
//
 ...
 * {@linkplain edu.rit.mp.CharacterBuf CharacterBuf}. See that class for further
 * information.
 *
...
// Exported constructors.
     ...
     * be 1.
     */
    public CharacterMatrixBuf_1(char[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new CharacterMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (CharacterOp) op);
    }
