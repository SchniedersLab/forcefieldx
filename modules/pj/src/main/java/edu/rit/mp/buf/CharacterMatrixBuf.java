...
// Unit:    Class edu.rit.mp.buf.CharacterMatrixBuf
//
...
// Exported constructors.
     ...
     */
    public CharacterMatrixBuf(char[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new CharacterMatrixReductionBuf(myMatrix, myRowRange, myColRange, (CharacterOp) op);
    }
