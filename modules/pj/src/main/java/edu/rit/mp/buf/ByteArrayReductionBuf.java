...
// Unit:    Class edu.rit.mp.buf.ByteArrayReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public ByteArrayReductionBuf(byte[] theArray,
            Range theRange,
            ByteOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("ByteArrayReductionBuf(): op is null");
        }
        myOp = op;
    }
