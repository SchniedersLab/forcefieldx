...
// Unit:    Class edu.rit.mp.buf.Signed16BitIntegerItemReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Signed16BitIntegerItemReductionBuf(Signed16BitIntegerItemBuf buf,
            IntegerOp op) {
        super(1);
        if (op == null) {
            throw new NullPointerException("Signed16BitIntegerItemReductionBuf(): op is null");
        }
        myBuf = buf;
        myOp = op;
    }
