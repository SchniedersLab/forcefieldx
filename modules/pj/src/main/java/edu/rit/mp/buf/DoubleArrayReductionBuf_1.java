...
// Unit:    Class edu.rit.mp.buf.DoubleArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public DoubleArrayReductionBuf_1(double[] theArray,
            Range theRange,
            DoubleOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("DoubleArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
