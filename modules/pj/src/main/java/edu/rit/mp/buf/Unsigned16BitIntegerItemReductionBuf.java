...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Unsigned16BitIntegerItemReductionBuf(Unsigned16BitIntegerItemBuf buf,
            IntegerOp op) {
        super(1);
        if (op == null) {
            throw new NullPointerException("Unsigned16BitIntegerItemReductionBuf(): op is null");
        }
        myBuf = buf;
        myOp = op;
    }
