...
// Unit:    Class edu.rit.mp.buf.SharedIntegerArrayReductionBuf_1
//
...
/**
 * Class SharedIntegerArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain SharedIntegerArrayBuf_1}.
 *
...
// Exported constructors.
    ...
    public SharedIntegerArrayReductionBuf_1(SharedIntegerArray theArray,
        ...
        if (op == null) {
            throw new NullPointerException("SharedIntegerArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
