...
// Unit:    Class edu.rit.mp.buf.Unsigned16BitIntegerArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     */
    public Unsigned16BitIntegerArrayReductionBuf_1(int[] theArray,
            Range theRange,
            IntegerOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("Unsigned16BitIntegerArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
