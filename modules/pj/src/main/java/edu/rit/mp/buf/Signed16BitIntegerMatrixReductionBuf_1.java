...
// Unit:    Class edu.rit.mp.buf.Signed16BitIntegerMatrixReductionBuf_1
//
...
// Exported constructors.
     ...
     */
    public Signed16BitIntegerMatrixReductionBuf_1(int[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            IntegerOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("Signed16BitIntegerMatrixReductionBuf_1(): op is null");
        }
        myOp = op;
    }
