...
// Unit:    Class edu.rit.mp.buf.Unsigned8BitIntegerMatrixReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Unsigned8BitIntegerMatrixReductionBuf(int[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            IntegerOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("Unsigned8BitIntegerMatrixReductionBuf(): op is null");
        }
        myOp = op;
    }
