...
// Unit:    Class edu.rit.mp.buf.BooleanArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public BooleanArrayReductionBuf_1(boolean[] theArray,
            Range theRange,
            BooleanOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("BooleanArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
