...
// Unit:    Class edu.rit.mp.buf.Signed16BitIntegerArrayBuf
//
 ...
 * a factory method in class {@linkplain edu.rit.mp.Signed16BitIntegerBuf
...
// Exported constructors.
     ...
     */
    public Signed16BitIntegerArrayBuf(int[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new Signed16BitIntegerArrayReductionBuf(myArray, myRange, (IntegerOp) op);
    }
