...
// Unit:    Class edu.rit.mp.buf.FloatArrayBuf
//
 ...
 * or greater than 1. While an instance of class FloatArrayBuf may be
 * constructed directly, normally you will use a factory method in class
 * {@linkplain edu.rit.mp.FloatBuf FloatBuf}. See that class for further
 * information.
 *
...
// Exported constructors.
     ...
     */
    public FloatArrayBuf(float[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new FloatArrayReductionBuf(myArray, myRange, (FloatOp) op);
    }
