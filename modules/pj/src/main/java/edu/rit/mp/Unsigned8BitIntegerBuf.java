...
// Package: edu.rit.mp
// Unit:    Class edu.rit.mp.Unsigned8BitIntegerBuf
//
...
import edu.rit.mp.buf.EmptyUnsigned8BitIntegerBuf;
import edu.rit.mp.buf.SharedUnsigned8BitIntegerArrayBuf;
import edu.rit.mp.buf.SharedUnsigned8BitIntegerArrayBuf_1;
import edu.rit.mp.buf.SharedUnsigned8BitIntegerBuf;
import edu.rit.mp.buf.Unsigned8BitIntegerArrayBuf;
import edu.rit.mp.buf.Unsigned8BitIntegerArrayBuf_1;
import edu.rit.mp.buf.Unsigned8BitIntegerItemBuf;
import edu.rit.mp.buf.Unsigned8BitIntegerMatrixBuf;
import edu.rit.mp.buf.Unsigned8BitIntegerMatrixBuf_1;
...
// Hidden constructors.
     ...
     */
    protected Unsigned8BitIntegerBuf(int theLength) {
...
// Exported operations.
     ...
     */
    public static Unsigned8BitIntegerBuf buffer(int[] theArray) {
        if (theArray == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.buffer(): theArray is null");
        }
     ...
     */
    public static Unsigned8BitIntegerBuf sliceBuffer(int[] theArray,
            Range theRange) {
        if (theArray == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.sliceBuffer(): theArray is null");
        }
        int nr = Arrays.length(theArray);
        if (0 > theRange.lb() || theRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Unsigned8BitIntegerBuf.sliceBuffer(): theArray index range = 0.."
     ...
     * <code>theRanges</code>.
     */
    public static Unsigned8BitIntegerBuf[] sliceBuffers(int[] theArray,
            Range[] theRanges) {
     ...
     */
    public static Unsigned8BitIntegerBuf rowSliceBuffer(int[][] theMatrix,
            Range theRowRange) {
        if (theMatrix == null) {
        ...
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Unsigned8BitIntegerBuf.rowSliceBuffer(): theMatrix row index range = 0.."
     ...
     */
    public static Unsigned8BitIntegerBuf[] rowSliceBuffers(int[][] theMatrix,
            Range[] theRowRanges) {
     ...
     */
    public static Unsigned8BitIntegerBuf colSliceBuffer(int[][] theMatrix,
            Range theColRange) {
        if (theMatrix == null) {
        ...
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("Unsigned8BitIntegerBuf.colSliceBuffer(): theMatrix column index range = 0.."
     ...
     */
    public static Unsigned8BitIntegerBuf[] colSliceBuffers(int[][] theMatrix,
            Range[] theColRanges) {
     ...
     */
    public static Unsigned8BitIntegerBuf patchBuffer(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
        if (theMatrix == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix is null");
        }
        int nr = Arrays.rowLength(theMatrix);
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix row index range = 0.."
                    + (nr - 1) + ", theRowRange = " + theRowRange);
        }
        int nc = Arrays.colLength(theMatrix, theRowRange.lb());
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix column index range = 0.."
                    + (nc - 1) + ", theColRange = " + theColRange);
        }
     ...
     * <code>theColRanges</code>.
     */
    public static Unsigned8BitIntegerBuf[] patchBuffers(int[][] theMatrix,
            Range[] theRowRanges,
            Range[] theColRanges) {
    ...
    public static Unsigned8BitIntegerBuf buffer(SharedInteger item) {
        if (item == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.buffer(): item is null");
        }
     ...
     * <code>theArray</code> is null.
     */
    public static Unsigned8BitIntegerBuf buffer(SharedIntegerArray theArray) {
        if (theArray == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.buffer(): theArray is null");
        }
        int nr = theArray.length();
        return new SharedUnsigned8BitIntegerArrayBuf_1(theArray, new Range(0, nr - 1));
    }
     ...
     * <code>theArray</code> does not include all the indexes in <code>theRange</code>.
     */
    public static Unsigned8BitIntegerBuf sliceBuffer(SharedIntegerArray theArray,
            Range theRange) {
        if (theArray == null) {
            throw new NullPointerException("Unsigned8BitIntegerBuf.sliceBuffer(): theArray is null");
        }
     ...
     * <code>theRanges</code>.
     */
    public static Unsigned8BitIntegerBuf[] sliceBuffers(SharedIntegerArray theArray,
            Range[] theRanges) {
        int n = theRanges.length;
        Unsigned8BitIntegerBuf[] result = new Unsigned8BitIntegerBuf[n];
        for (int i = 0; i < n; ++i) {
    ...
    public void copy(Buf theSrc) {
        if (theSrc != this) {
            defaultCopy((Unsigned8BitIntegerBuf) theSrc, this);
        }
    }
...
// Hidden operations.
     ...
     */
    protected static void defaultCopy(Unsigned8BitIntegerBuf theSrc,
