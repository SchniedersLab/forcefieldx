...
// Unit:    Class edu.rit.mp.buf.SharedLongArrayBuf
//
...
/**
 * Class SharedLongArrayBuf provides a buffer for a multiple thread safe array
 * of long items sent or received using the Message Protocol (MP). The array
 * element stride may be 1 or greater than 1. While an instance of class
 * SharedLongArrayBuf may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.LongBuf
...
// Exported constructors.
     ...
     */
    public SharedLongArrayBuf(SharedLongArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedLongArrayReductionBuf(myArray, myRange, (LongOp) op);
    }
