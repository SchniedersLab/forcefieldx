...
// Package: edu.rit.mp
// Unit:    Class edu.rit.mp.Signed16BitIntegerBuf
//
...
import edu.rit.mp.buf.EmptySigned16BitIntegerBuf;
import edu.rit.mp.buf.SharedSigned16BitIntegerArrayBuf;
import edu.rit.mp.buf.SharedSigned16BitIntegerArrayBuf_1;
import edu.rit.mp.buf.SharedSigned16BitIntegerBuf;
import edu.rit.mp.buf.Signed16BitIntegerArrayBuf;
import edu.rit.mp.buf.Signed16BitIntegerArrayBuf_1;
import edu.rit.mp.buf.Signed16BitIntegerItemBuf;
import edu.rit.mp.buf.Signed16BitIntegerMatrixBuf;
import edu.rit.mp.buf.Signed16BitIntegerMatrixBuf_1;
...
// Hidden constructors.
     ...
     * <TT>theLength</TT> &lt; 0.
     */
    protected Signed16BitIntegerBuf(int theLength) {
...
// Exported operations.
     ...
     * @return Buffer.
     */
    public static Signed16BitIntegerItemBuf buffer(int item) {
     ...
     */
    public static Signed16BitIntegerBuf buffer(int[] theArray) {
        if (theArray == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.buffer(): theArray is null");
        }
     ...
     */
    public static Signed16BitIntegerBuf sliceBuffer(int[] theArray,
            Range theRange) {
        if (theArray == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.sliceBuffer(): theArray is null");
        }
        int nr = Arrays.length(theArray);
        if (0 > theRange.lb() || theRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Signed16BitIntegerBuf.sliceBuffer(): theArray index range = 0.."
     ...
     * <TT>theRanges</TT>.
     */
    public static Signed16BitIntegerBuf[] sliceBuffers(int[] theArray,
            Range[] theRanges) {
     ...
     */
    public static Signed16BitIntegerBuf rowSliceBuffer(int[][] theMatrix,
            Range theRowRange) {
        if (theMatrix == null) {
        ...
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Signed16BitIntegerBuf.rowSliceBuffer(): theMatrix row index range = 0.."
     ...
     * <TT>theRowRanges</TT>.
     */
    public static Signed16BitIntegerBuf[] rowSliceBuffers(int[][] theMatrix,
            Range[] theRowRanges) {
     ...
     */
    public static Signed16BitIntegerBuf colSliceBuffer(int[][] theMatrix,
            Range theColRange) {
        if (theMatrix == null) {
        ...
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("Signed16BitIntegerBuf.colSliceBuffer(): theMatrix column index range = 0.."
     ...
     * <TT>theColRanges</TT>.
     */
    public static Signed16BitIntegerBuf[] colSliceBuffers(int[][] theMatrix,
            Range[] theColRanges) {
     ...
     * <TT>theColRange</TT>.
     */
    public static Signed16BitIntegerBuf patchBuffer(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
        if (theMatrix == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.patchBuffer(): theMatrix is null");
        }
        int nr = Arrays.rowLength(theMatrix);
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("Signed16BitIntegerBuf.patchBuffer(): theMatrix row index range = 0.."
                    + (nr - 1) + ", theRowRange = " + theRowRange);
        }
        int nc = Arrays.colLength(theMatrix, theRowRange.lb());
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("Signed16BitIntegerBuf.patchBuffer(): theMatrix column index range = 0.."
                    + (nc - 1) + ", theColRange = " + theColRange);
        }
     ...
     * <TT>theColRanges</TT>.
     */
    public static Signed16BitIntegerBuf[] patchBuffers(int[][] theMatrix,
            Range[] theRowRanges,
            Range[] theColRanges) {
     ...
     * @exception NullPointerException (unchecked exception) Thrown if
     * <TT>item</TT> is null.
     * @return a {@link edu.rit.mp.Signed16BitIntegerBuf} object.
     */
    public static Signed16BitIntegerBuf buffer(SharedInteger item) {
        if (item == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.buffer(): item is null");
        }
     ...
     * <TT>theArray</TT> is null.
     */
    public static Signed16BitIntegerBuf buffer(SharedIntegerArray theArray) {
        if (theArray == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.buffer(): theArray is null");
        }
     ...
     * <TT>theArray</TT> does not include all the indexes in <TT>theRange</TT>.
     */
    public static Signed16BitIntegerBuf sliceBuffer(SharedIntegerArray theArray,
            Range theRange) {
        if (theArray == null) {
            throw new NullPointerException("Signed16BitIntegerBuf.sliceBuffer(): theArray is null");
        }
     ...
     * <TT>theRanges</TT>.
     */
    public static Signed16BitIntegerBuf[] sliceBuffers(SharedIntegerArray theArray,
            Range[] theRanges) {
        int n = theRanges.length;
        Signed16BitIntegerBuf[] result = new Signed16BitIntegerBuf[n];
        for (int i = 0; i < n; ++i) {
    ...
    public void copy(Buf theSrc) {
        if (theSrc != this) {
            defaultCopy((Signed16BitIntegerBuf) theSrc, this);
        }
    }
...
// Hidden operations.
     ...
     */
    protected static void defaultCopy(Signed16BitIntegerBuf theSrc,
