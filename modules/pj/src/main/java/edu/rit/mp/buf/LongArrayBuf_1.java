...
// Unit:    Class edu.rit.mp.buf.LongArrayBuf_1
//
 ...
 * While an instance of class LongArrayBuf may be constructed directly, normally
 * you will use a factory method in class {@linkplain
 * edu.rit.mp.LongBuf LongBuf}. See that class for further information.
 *
...
// Exported constructors.
     ...
     */
    public LongArrayBuf_1(long[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new LongArrayReductionBuf_1(myArray, myRange, (LongOp) op);
    }
