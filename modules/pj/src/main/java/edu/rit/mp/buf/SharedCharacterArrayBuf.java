...
// Unit:    Class edu.rit.mp.buf.SharedCharacterArrayBuf
//
 ...
 * use a factory method in class {@linkplain edu.rit.mp.CharacterBuf
...
// Exported constructors.
     ...
     */
    public SharedCharacterArrayBuf(SharedCharacterArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedCharacterArrayReductionBuf(myArray, myRange, (CharacterOp) op);
    }
