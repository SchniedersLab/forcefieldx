...
// Unit:    Class edu.rit.mp.buf.SharedShortReductionBuf
//
...
// Exported constructors.
     ...
     */
    public SharedShortReductionBuf(SharedShort item,
            ShortOp op) {
        super(item);
        if (op == null) {
            throw new NullPointerException("SharedShortReductionBuf(): op is null");
        }
        myOp = op;
    }
