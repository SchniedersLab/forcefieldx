...
// Unit:    Class edu.rit.mp.buf.LongMatrixReductionBuf_1
//
...
// Exported constructors.
    /**
     * Construct a new long matrix reduction buffer. It is assumed that the rows
     * and columns of <code>theMatrix</code> are allocated and that each row of
     ...
     */
    public LongMatrixReductionBuf_1(long[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            LongOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("LongMatrixReductionBuf_1(): op is null");
        }
        myOp = op;
    }
