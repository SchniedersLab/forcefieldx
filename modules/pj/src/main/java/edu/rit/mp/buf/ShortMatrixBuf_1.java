...
// Unit:    Class edu.rit.mp.buf.ShortMatrixBuf_1
//
 ...
 * must both be 1. While an instance of class ShortMatrixBuf_1 may be
...
// Exported constructors.
     ...
     * be 1.
     */
    public ShortMatrixBuf_1(short[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new ShortMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (ShortOp) op);
    }
