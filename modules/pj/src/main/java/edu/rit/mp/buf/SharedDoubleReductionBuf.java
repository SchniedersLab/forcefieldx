...
// Unit:    Class edu.rit.mp.buf.SharedDoubleReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public SharedDoubleReductionBuf(SharedDouble item,
            DoubleOp op) {
        super(item);
        if (op == null) {
            throw new NullPointerException("SharedDoubleReductionBuf(): op is null");
        }
        myOp = op;
    }
