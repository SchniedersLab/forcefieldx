...
// Unit:    Class edu.rit.mp.buf.Signed8BitIntegerArrayBuf
//
 ...
 * a factory method in class {@linkplain edu.rit.mp.Signed8BitIntegerBuf
...
// Exported constructors.
     ...
     */
    public Signed8BitIntegerArrayBuf(int[] theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public void copy(Buf theSrc) {
        if (theSrc == this) {
            ...
            Signed8BitIntegerBuf.defaultCopy((Signed8BitIntegerBuf) theSrc, this);
        }
    }
    ...
    public Buf getReductionBuf(Op op) {
        return new Signed8BitIntegerArrayReductionBuf(myArray, myRange, (IntegerOp) op);
    }
