...
// Unit:    Class edu.rit.mp.buf.SharedUnsigned8BitIntegerReductionBuf
//
...
// Exported constructors.
     ...
     */
    public SharedUnsigned8BitIntegerReductionBuf(SharedInteger item,
            IntegerOp op) {
        super(item);
        if (op == null) {
            throw new NullPointerException("SharedUnsigned8BitIntegerReductionBuf(): op is null");
        }
        myOp = op;
    }
