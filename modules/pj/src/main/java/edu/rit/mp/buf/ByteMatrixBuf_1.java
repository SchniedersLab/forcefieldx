...
// Unit:    Class edu.rit.mp.buf.ByteMatrixBuf_1
//
 ...
 * edu.rit.mp.ByteBuf ByteBuf}. See that class for further information.
 *
...
// Exported constructors.
     ...
     * be 1.
     */
    public ByteMatrixBuf_1(byte[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new ByteMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (ByteOp) op);
    }
