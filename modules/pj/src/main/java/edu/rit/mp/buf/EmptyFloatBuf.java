...
// Unit:    Class edu.rit.mp.buf.EmptyFloatBuf
//
 ...
 * EmptyFloatBuf, the message item type is <code>float</code> and the message length
 * is 0. When a message is received into an EmptyFloatBuf, the message item type
 * must be <code>float</code>, but all items in the message are discarded.
 *
