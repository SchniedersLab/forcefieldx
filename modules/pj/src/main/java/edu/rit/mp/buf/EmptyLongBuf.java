...
// Unit:    Class edu.rit.mp.buf.EmptyLongBuf
//
 ...
 * using the Message Protocol (MP). When a message is sent from an EmptyLongBuf,
 * the message item type is <code>long</code> and the message length is 0. When a
 * message is received into an EmptyLongBuf, the message item type must be
 * <code>long</code>, but all items in the message are discarded.
 *
