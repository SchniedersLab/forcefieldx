...
// Unit:    Class edu.rit.mp.buf.SharedBooleanArrayBuf
//
...
// Exported constructors.
     ...
     */
    public SharedBooleanArrayBuf(SharedBooleanArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedBooleanArrayReductionBuf(myArray, myRange, (BooleanOp) op);
    }
