...
// Unit:    Class edu.rit.mp.buf.ObjectMatrixReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public ObjectMatrixReductionBuf_1(T[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            ObjectOp<T> op,
        ...
        if (op == null) {
            throw new NullPointerException("ObjectMatrixReductionBuf_1(): op is null");
        }
        myOp = op;
        myBuf = theBuf;
    }
