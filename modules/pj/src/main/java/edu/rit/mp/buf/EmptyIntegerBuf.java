...
// Unit:    Class edu.rit.mp.buf.EmptyIntegerBuf
//
 ...
 * EmptyIntegerBuf, the message item type is <code>int</code> and the message length
 * is 0. When a message is received into an EmptyIntegerBuf, the message item
 * type must be <code>int</code>, but all items in the message are discarded.
 *
