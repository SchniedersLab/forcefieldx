...
// Unit:    Class edu.rit.mp.buf.CharacterArrayReductionBuf_1
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public CharacterArrayReductionBuf_1(char[] theArray,
            Range theRange,
            CharacterOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("CharacterArrayReductionBuf_1(): op is null");
        }
        myOp = op;
    }
