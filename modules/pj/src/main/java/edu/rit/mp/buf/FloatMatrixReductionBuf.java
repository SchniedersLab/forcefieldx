...
// Unit:    Class edu.rit.mp.buf.FloatMatrixReductionBuf
//
...
// Exported constructors.
     ...
     */
    public FloatMatrixReductionBuf(float[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            FloatOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("FloatMatrixReductionBuf(): op is null");
        }
        myOp = op;
    }
