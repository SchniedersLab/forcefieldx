...
// Unit:    Class edu.rit.mp.buf.SharedFloatArrayBuf_1
//
 ...
 * array of float items sent or received using the Message Protocol (MP). The
 * array element stride must be 1. While an instance of class
 * SharedFloatArrayBuf_1 may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.FloatBuf FloatBuf}. See that
...
// Exported constructors.
     ...
     */
    public SharedFloatArrayBuf_1(SharedFloatArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedFloatArrayReductionBuf_1(myArray, myRange, (FloatOp) op);
    }
