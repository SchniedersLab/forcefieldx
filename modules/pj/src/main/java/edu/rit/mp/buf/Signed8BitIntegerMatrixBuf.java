...
// Unit:    Class edu.rit.mp.buf.Signed8BitIntegerMatrixBuf
//
...
// Exported constructors.
     ...
     */
    public Signed8BitIntegerMatrixBuf(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new Signed8BitIntegerMatrixReductionBuf(myMatrix, myRowRange, myColRange, (IntegerOp) op);
    }
