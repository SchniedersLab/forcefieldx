...
// Unit:    Class edu.rit.mp.buf.EmptyUnsigned16BitIntegerBuf
//
 ...
 * is unsigned 16-bit <code>int</code> and the message length is 0. When a message
 * is received into an EmptyUnsigned16BitIntegerBuf, the message item type must
 * be unsigned 16-bit <code>int</code>, but all items in the message are discarded.
 *
