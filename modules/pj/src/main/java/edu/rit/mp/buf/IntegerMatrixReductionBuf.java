...
// Unit:    Class edu.rit.mp.buf.IntegerMatrixReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public IntegerMatrixReductionBuf(int[][] theMatrix,
            Range theRowRange,
            Range theColRange,
            IntegerOp op) {
        super(theMatrix, theRowRange, theColRange);
        if (op == null) {
            throw new NullPointerException("IntegerMatrixReductionBuf(): op is null");
        }
        myOp = op;
    }
