...
// Unit:    Class edu.rit.mp.buf.IntegerMatrixBuf_1
//
 ...
 * strides must both be 1. While an instance of class IntegerMatrixBuf_1 may be
 * constructed directly, normally you will use a factory method in class
 * {@linkplain edu.rit.mp.IntegerBuf IntegerBuf}. See that class for further
 * information.
 *
...
// Exported constructors.
     ...
     * be 1.
     */
    public IntegerMatrixBuf_1(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new IntegerMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (IntegerOp) op);
    }
