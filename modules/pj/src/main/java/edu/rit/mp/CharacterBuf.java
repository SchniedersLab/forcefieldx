...
// Package: edu.rit.mp
// Unit:    Class edu.rit.mp.CharacterBuf
//
 ...
 * <LI><code>buffer()</code>
 * <LI><code>buffer (char)</code>
 * <LI><code>buffer (char[])</code>
 * <LI><code>sliceBuffer (char[], Range)</code>
 * <LI><code>sliceBuffers (char[], Range[])</code>
 * <LI><code>buffer (char[][])</code>
 * <LI><code>rowSliceBuffer (char[][], Range)</code>
 * <LI><code>rowSliceBuffers (char[][], Range[])</code>
 * <LI><code>colSliceBuffer (char[][], Range)</code>
 * <LI><code>colSliceBuffers (char[][], Range[])</code>
 * <LI><code>patchBuffer (char[][], Range, Range)</code>
 * <LI><code>patchBuffers (char[][], Range[], Range[])</code>
 * <LI><code>buffer (SharedCharacter)</code>
 * <LI><code>buffer (SharedCharacterArray)</code>
 * <LI><code>sliceBuffer (SharedCharacterArray, Range)</code>
 * <LI><code>sliceBuffers (SharedCharacterArray, Range[])</code>
 * </UL>
 *
...
// Exported operations.
     ...
     */
    public static CharacterBuf sliceBuffer(char[] theArray,
            Range theRange) {
        if (theArray == null) {
        ...
        if (0 > theRange.lb() || theRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("CharacterBuf.sliceBuffer(): theArray index range = 0.."
     ...
     * <code>theRanges</code>.
     */
    public static CharacterBuf[] sliceBuffers(char[] theArray,
            Range[] theRanges) {
     ...
     */
    public static CharacterBuf rowSliceBuffer(char[][] theMatrix,
            Range theRowRange) {
        if (theMatrix == null) {
        ...
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("CharacterBuf.rowSliceBuffer(): theMatrix row index range = 0.."
     ...
     */
    public static CharacterBuf[] rowSliceBuffers(char[][] theMatrix,
            Range[] theRowRanges) {
     ...
     */
    public static CharacterBuf colSliceBuffer(char[][] theMatrix,
            Range theColRange) {
        if (theMatrix == null) {
        ...
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("CharacterBuf.colSliceBuffer(): theMatrix column index range = 0.."
     ...
     */
    public static CharacterBuf[] colSliceBuffers(char[][] theMatrix,
            Range[] theColRanges) {
     ...
     */
    public static CharacterBuf patchBuffer(char[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
        if (theMatrix == null) {
        ...
        int nr = Arrays.rowLength(theMatrix);
        if (0 > theRowRange.lb() || theRowRange.ub() >= nr) {
            throw new IndexOutOfBoundsException("CharacterBuf.patchBuffer(): theMatrix row index range = 0.."
                    + (nr - 1) + ", theRowRange = " + theRowRange);
        }
        int nc = Arrays.colLength(theMatrix, theRowRange.lb());
        if (0 > theColRange.lb() || theColRange.ub() >= nc) {
            throw new IndexOutOfBoundsException("CharacterBuf.patchBuffer(): theMatrix column index range = 0.."
                    + (nc - 1) + ", theColRange = " + theColRange);
        }
     ...
     * <code>theColRanges</code>.
     */
    public static CharacterBuf[] patchBuffers(char[][] theMatrix,
            Range[] theRowRanges,
            Range[] theColRanges) {
     ...
     * instance of class {@linkplain edu.rit.pj.reduction.SharedCharacter
     ...
     * @return a {@link edu.rit.mp.CharacterBuf} object.
     */
     ...
     * <code>theArray</code> does not include all the indexes in <code>theRange</code>.
     */
    public static CharacterBuf sliceBuffer(SharedCharacterArray theArray,
            Range theRange) {
        if (theArray == null) {
            throw new NullPointerException("CharacterBuf.sliceBuffer(): theArray is null");
        }
     ...
     * <code>theRanges</code>.
     */
    public static CharacterBuf[] sliceBuffers(SharedCharacterArray theArray,
            Range[] theRanges) {
        int n = theRanges.length;
        CharacterBuf[] result = new CharacterBuf[n];
        for (int i = 0; i < n; ++i) {
    ...
    public void copy(Buf theSrc) {
        if (theSrc != this) {
            defaultCopy((CharacterBuf) theSrc, this);
        }
    }
     ...
     * <P>
     * The <code>item</code> must be an instance of class Character. If the
     * <code>item</code> is null, <code>'\u0000'</code> is assigned to each element in
     * this buffer.
...
// Hidden operations.
     ...
     */
    protected static void defaultCopy(CharacterBuf theSrc,
            CharacterBuf theDst) {
