...
// Unit:    Class edu.rit.mp.buf.Unsigned16BitIntegerArrayReductionBuf
//
...
// Exported constructors.
     ...
     * <TT>op</TT> is null.
     */
    public Unsigned16BitIntegerArrayReductionBuf(int[] theArray,
            Range theRange,
            IntegerOp op) {
        super(theArray, theRange);
        if (op == null) {
            throw new NullPointerException("Unsigned16BitIntegerArrayReductionBuf(): op is null");
        }
        myOp = op;
    }
