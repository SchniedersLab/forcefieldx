...
// Unit:    Class edu.rit.mp.buf.SharedUnsigned8BitIntegerBuf
//
...
// Exported constructors.
     ...
     */
    public SharedUnsigned8BitIntegerBuf(SharedInteger item) {
        super(1);
        myItem = item;
    }
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedUnsigned8BitIntegerReductionBuf(myItem, (IntegerOp) op);
    }
