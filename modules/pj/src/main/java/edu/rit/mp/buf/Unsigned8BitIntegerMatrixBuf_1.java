...
// Unit:    Class edu.rit.mp.buf.Unsigned8BitIntegerMatrixBuf_1
//
...
// Exported constructors.
     ...
     * be 1.
     */
    public Unsigned8BitIntegerMatrixBuf_1(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new Unsigned8BitIntegerMatrixReductionBuf_1(myMatrix, myRowRange, myColRange, (IntegerOp) op);
    }
