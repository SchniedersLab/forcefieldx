...
// Unit:    Class edu.rit.mp.buf.Signed16BitIntegerMatrixBuf
//
...
// Exported constructors.
     ...
     */
    public Signed16BitIntegerMatrixBuf(int[][] theMatrix,
            Range theRowRange,
            Range theColRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new Signed16BitIntegerMatrixReductionBuf(myMatrix, myRowRange, myColRange, (IntegerOp) op);
    }
