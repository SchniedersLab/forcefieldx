...
// Unit:    Class edu.rit.mp.buf.SharedDoubleArrayBuf_1
//
 ...
 * array of double items sent or received using the Message Protocol (MP). The
 * array element stride must be 1. While an instance of class
 * SharedDoubleArrayBuf_1 may be constructed directly, normally you will use a
 * factory method in class {@linkplain edu.rit.mp.DoubleBuf DoubleBuf}. See that
...
// Exported constructors.
     ...
     */
    public SharedDoubleArrayBuf_1(SharedDoubleArray theArray,
            Range theRange) {
...
// Exported operations.
    ...
    public Buf getReductionBuf(Op op) {
        return new SharedDoubleArrayReductionBuf_1(myArray, myRange, (DoubleOp) op);
    }
