 ...
 * Multipole Vals
 * Avg. Potential Before (and other stuff before like avg. unsigned diff)
 * Avg. Potential After (and other stuff after like avg. unsigned diff)
 * Test Phenobarbital and 12-ethanediol for now
 *
 *
...
public class Potential2Test {
    ...
    public Potential2Test(String info, String xyz_filename, double eps, int npoints, double[] mpoles, double[] potstats_before, double[] potstats_after){
        ...
        try {
            ...
            status = LBFGS.minimize(p.nvars, m, p.x, e, p.grad, eps, p.pme, p);
