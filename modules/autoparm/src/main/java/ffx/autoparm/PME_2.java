    ...
    private boolean assignMultipole(int i) {
        ...
        for (Bond b : bonds) {
            ...
            if (multipoleType != null) {
                ...
                atom.setMultipoleType(multipoleType);
                localMultipole[i][0] = multipoleType.getCharge();
                localMultipole[i][1] = multipoleType.getDipole()[0];
                localMultipole[i][2] = multipoleType.getDipole()[1];
                localMultipole[i][3] = multipoleType.getDipole()[2];
                localMultipole[i][4] = multipoleType.getQuadrupole()[0][0];
                localMultipole[i][5] = multipoleType.getQuadrupole()[1][1];
                localMultipole[i][6] = multipoleType.getQuadrupole()[2][2];
                localMultipole[i][7] = multipoleType.getQuadrupole()[0][1];
                localMultipole[i][8] = multipoleType.getQuadrupole()[0][2];
                localMultipole[i][9] = multipoleType.getQuadrupole()[1][2];
