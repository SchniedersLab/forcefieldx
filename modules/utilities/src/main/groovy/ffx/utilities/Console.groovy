...
import groovy.console.ui.ConsolePreferences
import groovy.console.ui.ConsoleTextEditor
import groovy.console.ui.ConsoleView
 ...
 *
 * The FFX version of Console makes the "doRun" method public, which allows scripting to be
 * invoked within the ModelingShell extension of Console.
 */
class Console implements CaretListener, HyperlinkListener, ComponentListener, FocusListener {
  ...
  public static URL ICON_PATH = Console.class.classLoader.getResource('ffx/ui/icons/icon64.png')
...
//    }
  ...
  @CompileStatic
  public Tuple2<Object, Long> doRun(boolean selected, SourceType st, HistoryRecord record) {
