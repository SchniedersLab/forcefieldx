...
public class Alchemical extends AlgorithmsCommand {
  ...
  public Alchemical run() {
    ...
    MolecularAssembly[] assemblies = new MolecularAssembly[]{activeAssembly};
    ...
    RefinementEnergy refinementEnergy = realSpaceOptions.toRealSpaceEnergy(filenames, assemblies);
    ...
    orthogonalSpaceTempering = new OrthogonalSpaceTempering(refinementEnergy,
    ...
    MolecularDynamics molDyn = new MolecularDynamics(assemblies[0], orthogonalSpaceTempering,
        algorithmListener, thermostat, integrator);
